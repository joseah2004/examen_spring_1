...
- **Patrón MVC** para separar responsabilidades:
  ...
  - **Controlador**: Endpoints que gestionan las peticiones HTTP.
...
- Controladores que reciben las peticiones y delegan la lógica al servicio.
- Servicios que encapsulan la lógica de negocio.
- Modelos/Entidades que representan los datos.
- Respuestas en formato **JSON** para facilitar la integración con otras aplicaciones


![Spring MVC](https://spring.io/images/spring-mvc-diagram-1.png)
